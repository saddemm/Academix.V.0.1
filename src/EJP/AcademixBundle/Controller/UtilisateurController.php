...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('EJPAcademixBundle:Utilisateur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EJP\AcademixBundle\Form\UtilisateurType', $utilisateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('EJP\AcademixBundle\Form\UtilisateurType', $utilisateur);
